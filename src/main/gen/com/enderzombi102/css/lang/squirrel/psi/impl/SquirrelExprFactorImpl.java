...
public class SquirrelExprFactorImpl extends ASTWrapperPsiElement implements SquirrelExprFactor {

  public SquirrelExprFactorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SquirrelVisitor visitor) {
    visitor.visitExprFactor(this);
  }
  ...
  @Override
  @NotNull
  public SquirrelExprUnary getExprUnary() {
    return findNotNullChildByClass(SquirrelExprUnary.class);
  }
