...
public class SquirrelExprGroupedImpl extends ASTWrapperPsiElement implements SquirrelExprGrouped {

  public SquirrelExprGroupedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SquirrelVisitor visitor) {
    visitor.visitExprGrouped(this);
  }
