...
public class SquirrelExprUnaryImpl extends ASTWrapperPsiElement implements SquirrelExprUnary {

  public SquirrelExprUnaryImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SquirrelExprAccess getExprAccess() {
    return findNotNullChildByClass(SquirrelExprAccess.class);
  }
