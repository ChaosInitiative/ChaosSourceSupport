...
public class SquirrelExprTernaryImpl extends ASTWrapperPsiElement implements SquirrelExprTernary {

  public SquirrelExprTernaryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SquirrelVisitor visitor) {
    visitor.visitExprTernary(this);
  }
  ...
  @Override
  @NotNull
  public SquirrelExprOr getExprOr() {
    return findNotNullChildByClass(SquirrelExprOr.class);
  }
