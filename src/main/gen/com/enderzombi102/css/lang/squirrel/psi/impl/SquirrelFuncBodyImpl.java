...
public class SquirrelFuncBodyImpl extends ASTWrapperPsiElement implements SquirrelFuncBody {

  public SquirrelFuncBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SquirrelArgs> getArgsList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SquirrelArgs.class);
  }
