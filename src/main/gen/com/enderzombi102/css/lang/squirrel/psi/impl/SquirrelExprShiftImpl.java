...
public class SquirrelExprShiftImpl extends ASTWrapperPsiElement implements SquirrelExprShift {

  public SquirrelExprShiftImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SquirrelVisitor visitor) {
    visitor.visitExprShift(this);
  }
  ...
  @Override
  @NotNull
  public SquirrelExprTerm getExprTerm() {
    return findNotNullChildByClass(SquirrelExprTerm.class);
  }
