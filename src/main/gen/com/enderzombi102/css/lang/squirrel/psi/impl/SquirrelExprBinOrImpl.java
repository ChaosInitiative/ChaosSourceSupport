...
public class SquirrelExprBinOrImpl extends ASTWrapperPsiElement implements SquirrelExprBinOr {

  public SquirrelExprBinOrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SquirrelVisitor visitor) {
    visitor.visitExprBinOr(this);
  }
  ...
  @Override
  @NotNull
  public SquirrelExprBinXor getExprBinXor() {
    return findNotNullChildByClass(SquirrelExprBinXor.class);
  }
