...
public class SquirrelExprComparImpl extends ASTWrapperPsiElement implements SquirrelExprCompar {

  public SquirrelExprComparImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SquirrelVisitor visitor) {
    visitor.visitExprCompar(this);
  }
  ...
  @Override
  @NotNull
  public SquirrelExprShift getExprShift() {
    return findNotNullChildByClass(SquirrelExprShift.class);
  }
