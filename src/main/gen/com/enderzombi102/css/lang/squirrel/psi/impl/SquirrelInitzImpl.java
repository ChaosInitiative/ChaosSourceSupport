...
public class SquirrelInitzImpl extends ASTWrapperPsiElement implements SquirrelInitz {

  public SquirrelInitzImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SquirrelVisitor visitor) {
    visitor.visitInitz(this);
  }
  ...
  @Override
  @Nullable
  public SquirrelInitz getInitz() {
    return findChildByClass(SquirrelInitz.class);
  }
