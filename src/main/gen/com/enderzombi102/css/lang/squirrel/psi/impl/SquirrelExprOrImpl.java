...
public class SquirrelExprOrImpl extends ASTWrapperPsiElement implements SquirrelExprOr {

  public SquirrelExprOrImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SquirrelExprAndIn getExprAndIn() {
    return findNotNullChildByClass(SquirrelExprAndIn.class);
  }
