...
public class SquirrelLocalDeclImpl extends ASTWrapperPsiElement implements SquirrelLocalDecl {

  public SquirrelLocalDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SquirrelInitz getInitz() {
    return findNotNullChildByClass(SquirrelInitz.class);
  }
