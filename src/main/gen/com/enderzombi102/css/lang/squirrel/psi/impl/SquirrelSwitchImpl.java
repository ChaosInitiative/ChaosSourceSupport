...
public class SquirrelSwitchImpl extends ASTWrapperPsiElement implements SquirrelSwitch {

  public SquirrelSwitchImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SquirrelCase> getCaseList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SquirrelCase.class);
  }
