...
public class SquirrelExprTermImpl extends ASTWrapperPsiElement implements SquirrelExprTerm {

  public SquirrelExprTermImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SquirrelExprFactor getExprFactor() {
    return findNotNullChildByClass(SquirrelExprFactor.class);
  }
