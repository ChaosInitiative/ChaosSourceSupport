...
public class SquirrelTslotsImpl extends ASTWrapperPsiElement implements SquirrelTslots {

  public SquirrelTslotsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SquirrelVisitor visitor) {
    visitor.visitTslots(this);
  }
  ...
  public SquirrelIdentifier getIdentifier() {
    return findChildByClass(SquirrelIdentifier.class);
  }
