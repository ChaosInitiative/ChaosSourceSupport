...
public class SquirrelEnumValueImpl extends ASTWrapperPsiElement implements SquirrelEnumValue {

  public SquirrelEnumValueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SquirrelPrimitive getPrimitive() {
    return findNotNullChildByClass(SquirrelPrimitive.class);
  }
