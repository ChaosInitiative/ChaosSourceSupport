...
public class SquirrelExprAssignImpl extends ASTWrapperPsiElement implements SquirrelExprAssign {

  public SquirrelExprAssignImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public SquirrelExprTernary getExprTernary() {
    return findNotNullChildByClass(SquirrelExprTernary.class);
  }
