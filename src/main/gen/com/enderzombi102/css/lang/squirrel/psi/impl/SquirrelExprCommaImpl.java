...
public class SquirrelExprCommaImpl extends ASTWrapperPsiElement implements SquirrelExprComma {

  public SquirrelExprCommaImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SquirrelVisitor visitor) {
    visitor.visitExprComma(this);
  }
  ...
  @Override
  @NotNull
  public SquirrelExprAssign getExprAssign() {
    return findNotNullChildByClass(SquirrelExprAssign.class);
  }
