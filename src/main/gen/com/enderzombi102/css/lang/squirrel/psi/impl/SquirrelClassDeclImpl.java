...
public class SquirrelClassDeclImpl extends ASTWrapperPsiElement implements SquirrelClassDecl {

  public SquirrelClassDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SquirrelDerefExpr> getDerefExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SquirrelDerefExpr.class);
  }
