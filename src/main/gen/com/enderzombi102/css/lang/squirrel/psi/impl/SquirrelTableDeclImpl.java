...
public class SquirrelTableDeclImpl extends ASTWrapperPsiElement implements SquirrelTableDecl {

  public SquirrelTableDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SquirrelVisitor visitor) {
    visitor.visitTableDecl(this);
  }
  ...
  @Override
  @NotNull
  public List<SquirrelTslots> getTslotsList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SquirrelTslots.class);
  }
