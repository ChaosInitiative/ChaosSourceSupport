...
public class SquirrelExprCallImpl extends ASTWrapperPsiElement implements SquirrelExprCall {

  public SquirrelExprCallImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SquirrelDerefExpr getDerefExpr() {
    return findNotNullChildByClass(SquirrelDerefExpr.class);
  }

  @Override
  @Nullable
  public SquirrelExprList getExprList() {
    return findChildByClass(SquirrelExprList.class);
  }
