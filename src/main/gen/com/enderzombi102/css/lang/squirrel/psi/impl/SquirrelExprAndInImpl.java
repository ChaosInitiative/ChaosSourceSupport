...
public class SquirrelExprAndInImpl extends ASTWrapperPsiElement implements SquirrelExprAndIn {

  public SquirrelExprAndInImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SquirrelVisitor visitor) {
    visitor.visitExprAndIn(this);
  }
  ...
  @Override
  @NotNull
  public SquirrelExprBinOr getExprBinOr() {
    return findNotNullChildByClass(SquirrelExprBinOr.class);
  }
