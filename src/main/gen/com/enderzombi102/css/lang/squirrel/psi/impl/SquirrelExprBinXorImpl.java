...
public class SquirrelExprBinXorImpl extends ASTWrapperPsiElement implements SquirrelExprBinXor {

  public SquirrelExprBinXorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SquirrelVisitor visitor) {
    visitor.visitExprBinXor(this);
  }
  ...
  @Override
  @NotNull
  public SquirrelExprBinAnd getExprBinAnd() {
    return findNotNullChildByClass(SquirrelExprBinAnd.class);
  }
